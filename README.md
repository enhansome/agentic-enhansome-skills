...
* **[zebbern/claude-code-guide](https://github.com/zebbern/claude-code-guide) ⭐ 4,594 | 🐛 1 | 🌐 Python | 📅 2026-08-29**: Comprehensive Security suite & Guide (Source for \~60 new skills).
...
* **[karanb192/awesome-claude-skills](https://github.com/karanb192/awesome-claude-skills) ⭐ 502 | 🐛 189 | 📅 2026-08-05**: A massive list of verified skills for Claude Code.
...
* **[ohad6k/ditto](https://github.com/ohad6k/ditto) ⭐ 278 | 🐛 21 | 🌐 Python | 📅 2026-08-24**: Source for the `ditto` skill - mines local coding-agent sessions into private, evidence-backed work, design, and writing profiles with dated source receipts (MIT).

* **[drogers0/gh-image](https://github.com/drogers0/gh-image) ⭐ 252 | 🐛 4 | 🌐 Go | 📅 2026-08-19**: Source for the `gh-image` skill - GitHub CLI image uploads that return canonical `user-attachments` embed URLs for PRs, issues, comments, and README screenshots (MIT).

* **[scarletkc/vexor](https://github.com/scarletkc/vexor) ⭐ 239 | 🐛 3 | 🌐 Python | 📅 2026-08-26**: Semantic search engine for files and code, referenced in release history.
...
* **[MohamedAbdallah-14/unslop](https://github.com/MohamedAbdallah-14/unslop) ⭐ 120 | 🐛 1 | 🌐 Python | 📅 2026-08-21**: Source for the `unslop` skill - deterministic and LLM-assisted cleanup for AI-generated prose across CLI and agent tool workflows.
...
* **[Ducksss/codex-profiles](https://github.com/Ducksss/codex-profiles) ⭐ 107 | 🐛 2 | 🌐 Shell | 📅 2026-08-28**: Source for the `codex-profiles` skill - Codex CLI/Desktop profile isolation around separate `CODEX_HOME` directories, diagnostics, and account-context boundaries without copying auth tokens (MIT).
...
* **[sandbaseai/sandbase-skills](https://github.com/sandbaseai/sandbase-skills) ⭐ 76 | 🐛 0 | 🌐 Python | 📅 2026-08-27**: Source for the `multi-source-search` skill - cross-validated research with explicit source diversity, confidence, conflicts, gaps, and an offline-checkable evidence ledger (Apache-2.0).
...
* **[adelaidasofia/ai-brain-starter](https://github.com/adelaidasofia/ai-brain-starter) ⭐ 35 | 🐛 32 | 🌐 Python | 📅 2026-08-29**: Source for the `ingest-youtube` skill - YouTube transcript ingestion into markdown vaults with yt-dlp metadata, VTT cleanup, and capture-seed stubs (MIT).
...
* **[263311487-ux/falsify](https://github.com/263311487-ux/falsify) ⭐ 0 | 🐛 0 | 🌐 HTML | 📅 2026-08-29**: Source for the `falsify` skill - a scientific reasoning protocol for explicit hypotheses, adversarial checks, evidence grading, and calibrated conclusions (MIT).
